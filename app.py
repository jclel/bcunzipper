...
# WRAP IT IN A TRY BLOCK FUCK IT

    # Make a list of folders in the current directory
    list_of_existing_folders = os.listdir(root_dir) # pyunzip
    for folder in list_of_existing_folders:
        # If a folder for the artist already exists
        if folder in artist_name:
            for album in os.listdir(artist_name):
        ...
        #     os.chdir(artist_name) # pyunzip/artist_name/
        #     new_dir = os.getcwd() # pyunzip/artist_name/
        #     list_of_albums = os.listdir(new_dir) # pyunzip/artist_name/
        #     for album in list_of_albums:
        #         if album in album_name:
        #             print(f"{album} already exists.")
        #             os.chdir(root_dir)
        #             break
        #         else: # if album doesn't exist
